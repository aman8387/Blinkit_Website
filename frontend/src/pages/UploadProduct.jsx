      ...
      <div className='grid p-3'>
        <form className='grid gap-4' onSubmit={handleSubmit}>
          ...
          {Object.keys(data.more_details).map((k, index) => (
            <div key={k + index} className='grid gap-1 relative'>
              <label htmlFor={k} className='font-medium flex justify-between items-center'>
                {k}
                {!["Disclaimer", "Return Policy"].includes(k) && (
                  <IoClose
                    size={18}
